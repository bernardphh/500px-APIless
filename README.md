...
To see how the results of data collection look like, see [main-html-page_demo.gif]("https://github.com/bernardphh/500px-APIless/blob/master/main-html-page_demo.gif") or go to the end of the page [here](#data-collection-demo)
